...
import vn.manroid.devchat.lib.emoji.EmojiconEditText;
import vn.manroid.devchat.lib.emoji.EmojiconGridFragment;
import vn.manroid.devchat.lib.emoji.EmojiconsFragment;
import vn.manroid.devchat.lib.model.Emojicon;
...
//            Log.i("onChildChanged", "Hello");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditEmojicon = findViewById(edtMessage);

        frameLayout = findViewById(R.id.emojicons);
        btnShowEmoji = findViewById(R.id.btnEmoji);
        btnSend = findViewById(R.id.btnSend);
        btnSend.setOnClickListener(onChatting);

        getSupportActionBar().setTitle("Chat với: " + friend.getName() != null ? friend.getName() : "Người lạ");
