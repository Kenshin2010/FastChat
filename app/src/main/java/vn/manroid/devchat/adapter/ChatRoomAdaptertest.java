...
public class ChatRoomAdaptertest extends BaseAdapter {

    private ArrayList<ChatRoomModel> listData;
    private LayoutInflater inflater;

    public ChatRoomAdaptertest(ArrayList<ChatRoomModel> listData, LayoutInflater inflater) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        ImageView imageView = view.findViewById(R.id.imgAvatarChattingRoom);

        TextView textView = view.findViewById(R.id.txtTextChatRoom);
